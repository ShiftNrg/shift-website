...
studioibizz.banner = {
  ...
  attach() {
    if (document.querySelector('.banner')) {
      ...
      studioibizz.banner.line1.innerHTML = wrapWords(
        studioibizz.banner.line1.innerHTML
      )
      ...
      studioibizz.banner.line1.insertBefore(
        studioibizz.banner.spacer1,
        studioibizz.banner.line1.childNodes[0]
      )
      ...
      studioibizz.banner.line2.innerHTML = wrapWords(
        studioibizz.banner.line2.innerHTML
      )
      const line2words = document.querySelectorAll('.slogan .line2 .word')
      line2words.forEach(function(word) {
        word.innerHTML = wrapChars(word.innerHTML)
      })
      studioibizz.banner.line2.insertBefore(
        studioibizz.banner.spacer2,
        studioibizz.banner.line2.childNodes[0]
      )
