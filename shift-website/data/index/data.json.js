    ...
    items: [
      {
        ...
        content: `<p>Dear Community,<br/><br/>Welcome to the new Shift Project website!</p>\
          ...
          <h2>Partnership: GreatFire and Shift to Tear Down the Great Firewall</h2><p>We on the Shift Team are incredibly happy and proud to be able to announce that GreatFire (greatfire.org) and Shift are partnering to transform how users in China browse the uncensored Internet and read uncensored news.</p>\
          ...
          <h2>Conclusion</h2><p>While it has been a long road, we are incredibly happy to have reached this point in our journey with the support of our community. We believe that partnering with GreatFire allows us to clearly demonstrate to the community and others our vision for the project and commitment to seeing that vision met. The Internet owes its creation to an ambition to connect people directly, peer-to-peer, without the incursion of state actors of large corporations into the management of communication protocols. By facilitating the provision and use of peer-to-peer hosting infrastructure free from unjust censorship, we hope the fundamental right to legitimately shared information will be better protected. This could then help unite people previously segregated, empower them to oppose their repression and, through their actions, subsequently achieve greater equality and liberty for all.</p>\
      ...
      },
      {
        ...
        intro:
          '<h2>- Update: V7.0.0t is now live at testnet -</h2><br/><p>Dear Community,</p><p>As you may be aware, we are currently carrying out an upgrade of the testnet version of Shift Core in order to allow the activation of functionalities that fully integrates the blockchain with the Phoenix IPFS cluster. We are now at an intermediary stage in this process, with the majority of forging testnet delegates having upgraded their nodes to version 6.9t and the cluster having been joined by peers run on systems owned by a number of members of the community, whose participation we greatly appreciate. This intermediary stage was begun by switching to Shift Core v6.9t from v6.8.4t, a version that was not designed to support a major version upgrade.</p>',
        content:
