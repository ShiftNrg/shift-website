...
import nuxt_plugin_nuxtsvgsprite_2de5a392 from 'nuxt_plugin_nuxtsvgsprite_2de5a392' // Source: ./nuxt-svg-sprite.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Shift Project","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Shift combines the transparency, immutability and decentralization of blockchain with the distributed hosting of the InterPlanetary File System"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_nuxtsvgsprite_2de5a392 === 'function') {
    await nuxt_plugin_nuxtsvgsprite_2de5a392(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_datajson_0541d330 === 'function') {
    await nuxt_plugin_datajson_0541d330(app.context, inject)
  }
